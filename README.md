...
Design, train, and test deep convolutional neural networks with transfer learning to perform a mask classification task with PyTorch and IBM Computer Vision Studio.
